package com.joyoudata.actuator.service.impl;
 ...
 * @Version 1.0
 */
public class EmailSendImpl implements SendMessage {
    private final static Logger log = LoggerFactory.getLogger(EmailSendImpl.class);
