...
import com.joyoudata.actuator.authentication.code.ImageCodeValidateFilter;
import com.joyoudata.actuator.authentication.mobile.MobileAuthenticationConfig;
import com.joyoudata.actuator.authentication.mobile.MobileValidateFilter;
import com.joyoudata.actuator.authentication.session.CustomLogoutHandler;
...
//                    "/code/image","/mobile/page", "/code/mobile"
                            securityProperties.getAuthentication().getLoginProcessingUrl(),
